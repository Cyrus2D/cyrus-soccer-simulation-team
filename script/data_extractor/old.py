...
if use_cluster:
    ...
    my_call_back = [
        keras.callbacks.ModelCheckpoint(filepath=run_name + '-best_model.{epoch:02d}-{val_accuracy:.3f}-{val_accuracy2:.3f}.h5', save_best_only=True, monitor='val_accuracy', mode='max'),
