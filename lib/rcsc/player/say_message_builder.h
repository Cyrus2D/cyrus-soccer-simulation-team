...
private:
    ...
    std::vector<int> M_unum_list;
    std::vector<int> M_mark_list;
public:

    /*!
      \brief construct with raw information
    */
    MarkMessage( std::vector<int> unum_list,std::vector<int> mark_list)
        : M_unum_list(unum_list),
          M_mark_list(mark_list)
      {
      }
    ...
    */
    ...
    int slength()
      {
          return MarkMessageParser::slength();
      }
