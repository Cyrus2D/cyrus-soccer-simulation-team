    ...
    , M_update_time( 0, 0 )
{
    ...
    M_self_cache_tackle.reserve( ( MAX_CYCLE + 2 ) * 2 );
...
InterceptTable::clear()
{
    ...
    M_self_exhaust_reach_cycle_tackle = 1000;
...
InterceptTable::update()
{
    ...
    dlog.addText( Logger::INTERCEPT,
                  "<-----Intercept Self reach cycle tackle = %d. exhaust reach step tackle = %d ",
                  M_self_reach_cycle_tackle,
                  M_self_exhaust_reach_cycle_tackle );
...
InterceptTable::predictSelf()
{
    ...
    SelfInterceptTackle predictor_tackle( M_world, M_ball_pos_cache );
    predictor_tackle.predict( max_cycle, M_self_cache_tackle );
...
InterceptTable::predictTeammate()
{
          ...
          ++it )
    {
        ...
        int cycle = predictor.predict(M_world, *(*it), *player_type,
                                       second_min_cycle );
        dlog.addText( Logger::INTERCEPT,
