...
private:
    ...
    static int S_pos_opp_goalie_count_thr;
...
public:
    ...
    */
    ...
    void set_count_thr( const int pos_thr,
                        ...
                        const int face_thr );
    static
    void set_count_thr_opp_goalie( const int pos_thr,
                        const int vel_thr,
                        const int face_thr );
    ...
    */
    bool posValid() const
      {
        if(goalie())
            return M_pos_count < S_pos_opp_goalie_count_thr;
    ...
    */
    bool rposValid() const
      {
        if(goalie())
                  return M_rpos_count < S_pos_opp_goalie_count_thr;
    ...
    */
    ...
    bool isTackleable(rcsc::Vector2D ball_pos, const double & buf = 0.05 ) const;
    // ------------------------------------------
    /*!
    ...
    */
    void updateByHearPosCount( const SideID heard_side,
    ...
    */
    ...
    void updateByHearSender( const SideID heard_side,
                       const int heard_unum,
                       const bool goalie,
                       const Vector2D & heard_pos,
                       const int sender,
