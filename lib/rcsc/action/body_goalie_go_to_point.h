...
#ifndef RCSC_ACTION_BODY_GOALIE_GO_TO_POINT_H
#define RCSC_ACTION_BODY_GOALIE_GO_TO_POINT_H
...
public:
    ...
    */
    Body_GoalieGoToPoint( const Vector2D & point,
...
private:
     ...
     */
    void checkGoalPost( const PlayerAgent * agent );
