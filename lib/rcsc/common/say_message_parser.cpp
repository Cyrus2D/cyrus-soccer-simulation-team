                          ...
                          const GameTime & current )
{
    ...
    if ( (int)std::strlen( msg ) < slength() )
    {
        ...
        dlog.addText( Logger::SENSOR,
                      "MarkMessageParser: Illegal ball info [%s]",
                      msg );
        return -1;
    }
    ++msg;
    ...
    std::vector<int> act;
    for(int i=1;i<=8;i++){
    	act.push_back(AudioCodec::i().hex2markaction(msg[i-1]));
    }

    dlog.addText(Logger::SENSOR,"act:%d %d %d %d %d %d %d %d",act[0],act[1],act[2],act[3],act[4],act[5],act[6],act[7]);
    M_memory->setMark( sender, act, current );
...
*/
PrePassMessageParser::PrePassMessageParser( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
PreCrossMessageParser::PreCrossMessageParser( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
OnePlayerMessageParser1::OnePlayerMessageParser1( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
OnePlayerMessageParser2::OnePlayerMessageParser2( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
TwoPlayerMessageParser01::TwoPlayerMessageParser01( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
TwoPlayerMessageParser02::TwoPlayerMessageParser02( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
ThreePlayerMessageParser001::ThreePlayerMessageParser001( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
ThreePlayerMessageParser002::ThreePlayerMessageParser002( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
ThreePlayerMessageParser011::ThreePlayerMessageParser011( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
ThreePlayerMessageParser012::ThreePlayerMessageParser012( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
...
ThreePlayerMessageParser022::ThreePlayerMessageParser022( boost::shared_ptr< AudioMemory > memory )
    : M_memory( memory )
{
