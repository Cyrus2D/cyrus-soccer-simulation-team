...
public:
    ...
    **************************************************/
    ...
    static const boost::int32_t TH_PASS = LEVEL_22; //!< log level definition alias
    static const boost::int32_t L_PASS = LEVEL_23; //!< log level definition alias
    static const boost::int32_t D_PASS = LEVEL_24; //!< log level definition alias
    static const boost::int32_t C_PASS = LEVEL_25; //!< log level definition alias
