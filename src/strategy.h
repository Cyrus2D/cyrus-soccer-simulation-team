...
public:
    ...
    static const std::string F523_DEFENSE_FORMATION_CONF_NO5;
    static const std::string F523_DEFENSE_FORMATION_CONF_NO6;
    static const std::string F523_DEFENSE_FORMATION_CONF_NO56;
